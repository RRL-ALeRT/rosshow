...
VIEWER_MAPPING = {
    "nav_msgs/Odometry": (
        "rosshow.viewers.nav_msgs.OdometryViewer",
        "OdometryViewer",
        {},
    ),
    "nav_msgs/OccupancyGrid": (
        "rosshow.viewers.nav_msgs.OccupancyGridViewer",
        "OccupancyGridViewer",
        {},
    ),
    "nav_msgs/Path": ("rosshow.viewers.nav_msgs.PathViewer", "PathViewer", {}),
    "std_msgs/Bool": (
        "rosshow.viewers.generic.SinglePlotViewer",
        "SinglePlotViewer",
        {},
    ),
    "std_msgs/Float32": (
    ...
    "sensor_msgs/CompressedImage": (
        "rosshow.viewers.sensor_msgs.CompressedImageViewer",
    ...
    "sensor_msgs/FluidPressure": (
        "rosshow.viewers.generic.SinglePlotViewer",
        "SinglePlotViewer",
        {"data_field": "fluid_pressure"},
    ),
    "sensor_msgs/RelativeHumidity": (
        "rosshow.viewers.generic.SinglePlotViewer",
        "SinglePlotViewer",
        {"data_field": "relative_humidity"},
    ),
    "sensor_msgs/Illuminance": (
        "rosshow.viewers.generic.SinglePlotViewer",
        "SinglePlotViewer",
        {"data_field": "illuminance"},
    ),
    ...
    "sensor_msgs/LaserScan": (
        "rosshow.viewers.sensor_msgs.LaserScanViewer",
        "LaserScanViewer",
        {},
    ),
    "sensor_msgs/NavSatFix": (
        "rosshow.viewers.sensor_msgs.NavSatFixViewer",
        "NavSatFixViewer",
        {},
    ),
    "sensor_msgs/PointCloud2": (
        "rosshow.viewers.sensor_msgs.PointCloud2Viewer",
        "PointCloud2Viewer",
        {},
    ),
    "sensor_msgs/Range": (
    ...
    "geometry_msgs/Twist": (
        "rosshow.viewers.generic.MultiPlotViewer",
        "MultiPlotViewer",
        {
            "data_fields": [
                "linear.x",
...
def main():
    ...
    message_class = getattr(
        __import__(message_package + ".msg", fromlist=(message_name)), message_name
    )
